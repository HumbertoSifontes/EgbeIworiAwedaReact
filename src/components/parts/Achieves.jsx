    ...
    <section className="logro section-padding" id="logro">
		<div className="container miniSectionServices">
			...
			<div className="row gy-3">
				<motion.div className="col-12 col-md-12 col-lg-4" variants={fadeIn('right', 0.2)} initial='hidden' whileInView='show' exit='hidden'  viewport={{ once: true }} layoutScroll>
				...
				<motion.div className="col-12 col-md-12 col-lg-4" variants={fadeIn('left', 0.2)} initial='hidden' whileInView='show' exit='hidden'  viewport={{ once: true }} layoutScroll>
					<div className="card text-light text-center pb-2 intentoCard2">
						<div className="card-body text-dark d-flex flex-column justify-content-between align-items-center">
							<div className="row align-items-center">
								<div className="img-area mb-4">
